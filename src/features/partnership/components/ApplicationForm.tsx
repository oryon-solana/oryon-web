...
export default function ApplicationForm({
  ...
  return (
    <div className="animate-slide-up" style={{ animationDelay: "50ms" }}>
      ...
      >
        <h2 className="text-xl font-bold text-[#e8f0f8] mb-1 tracking-tight">
          Merchant Application
        </h2>
        <p className="text-[13px] text-[#5a7090] mb-8">
          Fill in your brand details to get listed.
        </p>

        <form onSubmit={onSubmit} className="flex flex-col gap-5">
          {/* Name */}
          <div className="flex flex-col gap-1.5">
            <label className="text-[13px] font-semibold text-[#a0b4c8] tracking-[0.01em]">
              Merchant Name
            </label>
            <input
              type="text"
              ...
              style={
                focused.name && !errors.name
                  ? { boxShadow: "0 0 0 3px oklch(0.60 0.22 250 / 0.12)" }
                  : undefined
              }
            />
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-baseline justify-between">
              ...
              <span className="text-[11px] text-[#5a7090] font-[family-name:var(--font-mono)]">
            ...
            <div className="relative">
              <input
                ...
                className={cn(
                  inputCls(!!focused.earnRate, !!errors.earnRate),
                  "pr-11",
                )}
                style={
                  focused.earnRate && !errors.earnRate
                    ? { boxShadow: "0 0 0 3px oklch(0.60 0.22 250 / 0.12)" }
                    : undefined
                }
              />
            ...
            <p className="text-[11px] text-[#5a7090] font-[family-name:var(--font-mono)]">
              Users earn this many points per 1 transaction unit
            </p>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[13px] font-bold font-[family-name:var(--font-mono)] text-[#5a7090] select-none">
                Rp
              </span>
              <input
                type="number"
                ...
                className={cn(
                  inputCls(!!focused.pointValueIDR, !!errors.pointValueIDR),
                  "pl-10",
                )}
                style={
                  focused.pointValueIDR && !errors.pointValueIDR
                    ? { boxShadow: "0 0 0 3px oklch(0.60 0.22 250 / 0.12)" }
                    : undefined
                }
              />
            ...
            <p className="text-[11px] text-[#5a7090] font-[family-name:var(--font-mono)]">
              Monetary value assigned to each loyalty point
            </p>
          ...
          {hasPreview && (
            ...
            >
              <div className="text-[10px] font-[family-name:var(--font-mono)] text-[#5a7090] tracking-[0.1em] uppercase mb-3">
                Preview
              </div>
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-xl bg-[#1e2a3a] flex items-center justify-center shrink-0 text-lg">
                  🏪
                </div>
                <div>
                  <div className="text-[15px] font-bold text-[#e8f0f8] mb-0.5">
                    {form.name || "Your Brand"}
                  </div>
                  <div className="text-[11px] text-[#5a7090] font-[family-name:var(--font-mono)]">
                    Loyalty Program
                  </div>
                </div>
              </div>
              <div
                className="grid grid-cols-2 gap-2 mt-3 rounded-xl p-3"
                style={{ background: "#0d1117" }}
              >
                <div>
                  <div className="text-[9px] text-[#5a7090] font-[family-name:var(--font-mono)] uppercase tracking-[0.06em] mb-0.5">
                    Earn Rate
                  </div>
                  <div
                ...
                <div className="border-l border-[#1e2a3a] pl-3">
                  ...
                  <div className="text-base font-bold font-[family-name:var(--font-mono)] text-[#e8f0f8]">
                    {form.pointValueIDR
                      ? `Rp${Number(form.pointValueIDR).toLocaleString("id-ID")}`
                      : "—"}
                  </div>
                </div>
              </div>
          ...
          {txError && (
            <div
              className="flex items-start gap-2.5 rounded-xl px-3.5 py-3 text-[12.5px] text-red-400 animate-fade-in"
              style={{
