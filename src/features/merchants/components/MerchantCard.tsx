    ...
    >
      {hov && (
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 100% at 50% -20%, oklch(0.60 0.22 250 / 0.1), transparent)",
          }}
        />
      )}
      ...
      <div className="absolute top-3.5 right-3.5">
        {m.active ? (
          ...
          >
            ...
            />
            <span
              className="text-[9px] font-bold font-[family-name:var(--font-mono)] tracking-[0.06em] uppercase"
          ...
          <div
            className="flex items-center gap-1 rounded-full px-2 py-[3px] bg-[#161e2a]"
            style={{ border: "1px solid #2a3a50" }}
          >
            <div className="w-[5px] h-[5px] rounded-full bg-[#5a7090]" />
            <span className="text-[9px] font-bold font-[family-name:var(--font-mono)] tracking-[0.06em] uppercase text-[#5a7090]">
              Soon
            </span>
          </div>
        )}
      ...
      <div
        ...
        style={{
          boxShadow: hov
            ? "0 0 24px oklch(0.60 0.22 250 / 0.15)"
      ...
      >
        <div>
          <div className="text-[10px] text-[#5a7090] font-[family-name:var(--font-mono)] uppercase tracking-[0.06em] mb-0.5">
            Earn Rate
          </div>
          <div
            className="text-[15px] font-bold font-[family-name:var(--font-mono)]"
        ...
        <div className="border-l border-[#1e2a3a] pl-3">
          ...
          <div className="text-[15px] font-bold font-[family-name:var(--font-mono)] text-[#e8f0f8]">
            Rp{m.pointValueIDR.toLocaleString()}
          </div>
        </div>
      </div>
    </div>
